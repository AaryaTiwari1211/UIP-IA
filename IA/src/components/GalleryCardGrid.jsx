                ...
                <Grid container spacing={2} sx={{
                    ...
                    <Grid item xs={12} sm={6} md={4} className='hover:scale-105 duration-500 ease-in-out'>
                        ...
                        <Typography variant='h5' sx={{
                            pt: 1,
                        }} className='text-penk text-start bg-black'>Dhairya Satra</Typography>
                    ...
                    <Grid item xs={12} sm={6} md={4} className='hover:scale-105 duration-500 ease-in-out'>
                        ...
                        <Typography variant='h5' sx={{
                            pt: 1,
                        }} className='text-penk text-start bg-black'>Dhruv Sharma</Typography>
                    ...
                    <Grid item xs={12} sm={6} md={4} className='hover:scale-105 duration-500 ease-in-out'>
                        ...
                        <Typography variant='h5' sx={{
                            pt: 1,
                        }} className='text-penk text-start bg-black'>Aarya Tiwari</Typography>
